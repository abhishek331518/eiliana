...
export class RegisterOtpScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      username: '',
  ...
  validationErrorMessage = (event) => {
    ...
    switch (name) {
      case 'username': 
        errors.username = value.length < 1 ? 'Enter Otp' : '';
        break;
      case 'password': 
      ...
      <div className="pagecenter loginForm">
        <form>
          <div className="row">
            ...
            <label htmlFor="username" className="col-sm-2 col-form-label">Otp:</label>
            <div className="col-sm-3 mb-2">
              <input type="text" value={username} name="username" onChange={(e) => { this.inputChange(e)} } className="form-control" id="username" placeholder="Otp!" />
